      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="<?php echo base_url().'admin/Videos'?>"><i class="fa fa-picture-o"></i> Videos</a></li>
          </ul>
        </li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><iframe width="420" height="315" src="https://www.youtube.com/embed/tgbNymZ7vqY"> </iframe></td>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/videos/simpan_videos'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xvideo" class="form-control" id="inputUserName" placeholder="Link Video" required>
                                        </div>
                                    </div>
                    </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $video_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/videos/update_video'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                                <input type="hidden" name="kode" value="<?php echo $video_id;?>"/>
                                <input type="hidden" value="<?php echo $video_gambar;?>" name="gambar">
                                  <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Judul</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xjudul" class="form-control" value="<?php echo $video_judul;?>" id="inputUserName" placeholder="Judul" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Link Video</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xvideo" class="form-control" value="<?php echo $video_link;?>" id="inputUserName" placeholder="Judul" required>
                                        </div>
                                    </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $video_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/videos/hapus_video'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $video_id;?>"/>
                            <p>Apakah Anda yakin mau menghapus Posting <b><?php echo $video_judul;?></b> ?</p>
