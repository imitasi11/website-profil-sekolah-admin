...
<head>
    ...
    <title>PENGUMUMAN ASH-SHOLAWAAT</title>
                    ...
                    <nav  class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded" >
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown" style="float: right;">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('pengumuman');?>" style="color: #e3b30d;
    border-bottom: 3px solid #e3b30d;"><b>PENGUMUMAN</b></a>
                                </li>
                                <li class="nav-item">
